...
<body class="" onload="document.getElementById('form1').email.focus()">
   ...
   <div class="navbar">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html"><span class="first"></span><span class="second">飞跃软件工场信息管理平台</span></a>
        </div>
    </div>
    ...
    <div class="row-fluid">
        <div class="dialog">
            <div class="block">
                ...
                <div class="block-body">
                    ...
                    <div id="email2" class=" control-group">
                        ...
                        <div class="controls">
                        <input id="email" type="text" class="span12" name="email">
            ...
            <p><a href="#">忘记密码?</a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="user/reqiste.do">点我注册</a></p>
        </div>
    </div>
