        ...
        <div class="dialog">
            <div class="block">
                ...
                <div class="block-body">
                  <%--  <form action="<%=request.getContextPath() %>/user/reqiste1.do" method="post" onsubmit="return registers('click')">
                   --%>
                    <form >
                      <div class="control-group" id="name2">
                       ...
                       <div class=" control-group" id="idcard2">
                        ...
                        <div class="controls">
                        <input type="text" id="idcard" class="span12" name="idcard" value="${user.idcard}">
                        <span class="stats1" id="idcard1">请填写您本人的身份证号码</span>
                        </div>
                       </div>
                       ...
                       <div class=" control-group" id="phone2">
                        ...
                        <div class="controls">
                        <input type="text" id="phone" class="span12" name="phone" value="${user.phone}">
                        <span class="stats1" id="phone1">请填写您的手机号码</span>
                        </div>
                       </div>
                       ...
                       <div class=" control-group" id="email2">
                        ...
                        <div class="controls">
                        <input type="text" id="email" class="span12" name="email" value="${user.email}">
